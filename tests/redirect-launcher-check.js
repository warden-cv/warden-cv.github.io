...
assert(html.includes('data-product="warden"'),'generated redirect page missing product id');
assert(html.includes('data-default-port="7332"'),'generated redirect page missing default port');
...
console.log('warden redirect launcher check: ok');
